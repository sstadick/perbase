...
![Performance comparison between perbase and sambamba showing runtime in milliseconds for both standard and mate-fix modes. perbase demonstrates 3.0x faster performance in standard mode and 2.3x faster performance in mate-fix mode.](outputs/benchmark_comparison.png)
